...
class LyricUtil {
  static List<Lyric> formatLyric(String lyricStr, bool isVideo) {
    RegExp reg =
    ...
    var lyrics = matches.map((m) {
      ...
      var duration = lyricTimeToDuration(time, isVideo);
  ...
  static Duration lyricTimeToDuration(String time, bool isVideo) {
